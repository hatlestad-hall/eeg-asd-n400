...
cfg.st_plot.events		= { 'related'; 'unrelated'; { 'related', 'unrelated' } };
cfg.st_plot.cond_label	= { 'Related', 'Unrelated', 'All' };
...
cfg.comp_plot.events		= { 'related'; 'unrelated' };
cfg.comp_plot.cond_label	= { 'Related', 'Unrelated' };
cfg.comp_plot.variance		= 'none';
cfg.comp_plot.channel		= { 'Cz', 'FCz', 'CPz' };
cfg.comp_plot.reref			= [ ];
cfg.comp_plot.montage		= '64';
cfg.comp_plot.bl_corr		= [ ];
cfg.comp_plot.colour		= { [ 0, 0, 0, 0.75 ], [ 1, 0, 0, 0.75 ] };
